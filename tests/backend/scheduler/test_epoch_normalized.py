...
def test_some_still_new() -> None:
    tasks = _get_next_tasks(
        ...
        [
            _Training(
                training_id=100,
                total_duration=timedelta(seconds=130),
                next_epoch=2,
                metric_value=METRIC_VALUE,
            ),
            _Training(
...
def test_all_in_round_0() -> None:
    tasks = _get_next_tasks(
        ...
        [
            ...
            _Training(
                training_id=8,
                total_duration=timedelta(seconds=59),
                next_epoch=2,
                metric_value=METRIC_VALUE,
            ),
        ],
...
def test_all_in_round_1() -> None:
    tasks = _get_next_tasks(
        ...
        [
            ...
            _Training(
                training_id=105,
                total_duration=timedelta(seconds=160),
                next_epoch=18,
                metric_value=METRIC_VALUE,
            ),
            _Training(
                training_id=8,
                total_duration=timedelta(seconds=119),
                next_epoch=2,
                metric_value=METRIC_VALUE,
            ),
            _Training(
                training_id=9,
                total_duration=timedelta(seconds=165),
                next_epoch=2,
                metric_value=METRIC_VALUE,
            ),
            _Training(
...
def test_some_still_in_round_0() -> None:
    tasks = _get_next_tasks(
        ...
        [
            ...
            _Training(
                training_id=108,
                total_duration=timedelta(seconds=55),
                next_epoch=2,
                metric_value=METRIC_VALUE,
            ),
            _Training(
